...
SRC_URI="https://github.com/downloads/perfwatcher/collectd-pw/collectd-5.1.1.20121121.tar.bz2"
...
src_configure() {
	...
	myconf+=" --enable-jsonrpc --enable-notify_file --enable-basic_aggregator"
...
src_install() {
	...
	cp ${WORKDIR}/${P}/src/types-perfwatcher.db ${D}/etc

	fowners root:collectd /etc/collectd.conf /etc/types-perfwatcher.db
	fperms u=rw,g=r,o= /etc/collectd.conf /etc/types-perfwatcher.db
